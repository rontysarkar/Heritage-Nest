        ...
        <div className="hero  my-28 ">
            <div className="w-full hero-content flex-col lg:flex-row-reverse gap-5 justify-between  " >
                ...
                <div className="w-1/2 space-y-5 content-start">
                    ...
                    <Link to={'buy'}> <button className="flex items-center  gap-2  px-5 py-2 mt-4 text-sm font-medium text-blue-950 hover:text-white capitalize transition-colors duration-300 transform bg-blue-100 hover:bg-black rounded-md lg:w-auto y"> <CiSearch className="text-xl" />Find Property</button> </Link>
