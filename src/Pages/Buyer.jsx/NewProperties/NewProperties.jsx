...
import useNewProperty from "../../../Hooks/useNewProperty";


const NewProperties = () => {
    const [properties] = useNewProperty()
    ...
    return (
        <div className="max-w-7xl mx-auto my-20">
            <div className="flex items-center justify-between px-6">
                <h1 className="text-xl lg:text-4xl font-bold ">New Listed Properties</h1>
                <h1 className="underline font-bold text-blue-600 cursor-pointer">See all Property</h1>
            </div>
                ...
                >
                    {
                        properties?.map((property, index) => <SwiperSlide key={index}>
                            <Link to={`/propertyDetails/${property?.id}`}><div className="w-full max-w-sm overflow-hidden  rounded-lg shadow-lg mx-auto ">
